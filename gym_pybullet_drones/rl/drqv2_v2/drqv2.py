...
class Encoder(nn.Module):
    def __init__(self, obs_shape, state_dim=0):
        super().__init__()
        ...
        # Add state encoder if states are provided
        if self.has_state:
            ...
            # Adjust representation dimension to include state encoding
            self.repr_dim += 128
    ...
    def forward(self, obs, state=None):
        ...
        if self.has_state and state is not None:
            ...
            h = torch.cat([h, state_repr], dim=1)
